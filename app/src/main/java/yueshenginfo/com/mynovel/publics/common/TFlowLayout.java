...
public class TFlowLayout extends FlowLayout implements TagAdapter1.OnDataChangedListener {
    private TagAdapter1 mTagAdapter;
    ...
    public TFlowLayout(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        TypedArray ta = context.obtainStyledAttributes(attrs, com.zhy.view.flowlayout.R.styleable.TagFlowLayout);
        mAutoSelectEffect = ta.getBoolean(com.zhy.view.flowlayout.R.styleable.TagFlowLayout_auto_select_effect, true);
    ...
    public void setAdapter(TagAdapter1 adapter) {
    ...
    private void changeAdapter() {
        removeAllViews();
        TagAdapter1 adapter = mTagAdapter;
